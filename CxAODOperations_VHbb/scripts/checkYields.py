...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                     description="Check yields with expectation from AMI")     
    parser.add_argument('-y', '--yieldsfile', help='CxAOD DAOD yields file', default='yields.13TeV_DxAOD_sorted.txt')     
    parser.add_argument('-a', '--amifile', help='AMI DxAOD yields', default='dslist_NevtDxAOD.txt')     
